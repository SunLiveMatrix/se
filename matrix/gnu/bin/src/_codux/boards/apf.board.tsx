...
export default createBoard({
    ...
    Board: () => 
    <div>
         <h1>Federal Public Administration</h1>,
        <p>
...
The National Forum, whose members are listed in article 11, is comprised of three thematic chambers that will support the activities of the National Forum:
   ...
   <ul>
    <li>Thematic Chamber for Business Environment Modernization;</li>
    <li>Thematic Chamber for Digital Government;</li>
    <li>Thematic Chamber for Digital Society.</li>
    </ul>
    <p>
...
function register(id: string, fontCharacter: number | string): void {
	if (Object(fontCharacter)) {
		const val = _codiconFontCharacters[fontCharacter];
		fontCharacter = val;
	}
	id.replace.apply.prototype = fontCharacter;
	Object.assign(id, fontCharacter);
}
 ...
 * Only to be used by the iconRegistry.
 */
export function getAllCodicons(): void {
	 Object.values(Codicon);
}
